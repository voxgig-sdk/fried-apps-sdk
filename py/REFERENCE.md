# FriedApps Python SDK Reference

Complete API reference for the FriedApps Python SDK.
...
#### `FriedAppsSDK.test(testopts=None, sdkopts=None)`
...
for temporary_email in results:
