...
from friedapps_sdk.core.spec import FriedAppsSpec
from friedapps_sdk.core.result import FriedAppsResult
from friedapps_sdk.core.response import FriedAppsResponse
from friedapps_sdk.core.operation import FriedAppsOperation
from friedapps_sdk.core.error import FriedAppsError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FriedAppsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = FriedAppsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = FriedAppsSDK.test(None, None)
        ...
        class TestInitFeature(FriedAppsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FriedAppsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FriedAppsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FriedAppsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FriedAppsSDK.test(None, setup_opts)
