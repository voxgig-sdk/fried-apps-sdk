...
class FriedAppsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FriedAppsTestRunner.getenv("FRIEDAPPS_TEST_LIVE")
        override = FriedAppsTestRunner.getenv("FRIEDAPPS_TEST_OVERRIDE")
        ...
        explain = FriedAppsTestRunner.getenv("FRIEDAPPS_TEST_EXPLAIN")
