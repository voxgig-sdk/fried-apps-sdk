...
class FriedAppsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FriedAppsTestRunner.getenv("FRIED_APPS_TEST_LIVE")
        override = FriedAppsTestRunner.getenv("FRIED_APPS_TEST_OVERRIDE")
        ...
        explain = FriedAppsTestRunner.getenv("FRIED_APPS_TEST_EXPLAIN")
