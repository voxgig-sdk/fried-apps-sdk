# FriedApps SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FriedAppsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FriedAppsSDK(...) and FriedAppsSDK.test(...) become
#      FriedAppsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "friedapps_sdk"
_SDK_CLASS = "FriedAppsSDK"
