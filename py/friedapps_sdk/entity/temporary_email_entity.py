...
from friedapps_sdk.friedapps_types import (
    TemporaryEmail,
...
class TemporaryEmailEntity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TemporaryEmail]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TemporaryEmail().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
