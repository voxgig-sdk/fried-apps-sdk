...
from friedapps_sdk.core.control import FriedAppsControl
...
from friedapps_sdk.core.helpers import get_ctx_prop, to_map
...
class FriedAppsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FriedAppsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FriedAppsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FriedAppsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FriedAppsError(code, msg, self)
