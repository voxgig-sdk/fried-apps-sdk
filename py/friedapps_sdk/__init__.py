...
from friedapps_sdk.utility import register

# Load features
from friedapps_sdk.feature.base_feature import FriedAppsBaseFeature
from friedapps_sdk.features import _has_feature, _make_feature
...
class FriedAppsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FriedAppsUtility()
        self._utility = utility

        from friedapps_sdk.config import shared_config
    ...
    def get_utility(self):
        return FriedAppsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FriedAppsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def TemporaryEmail(self, data=None) -> "TemporaryEmailEntity":
        ...
        from friedapps_sdk.entity.temporary_email_entity import TemporaryEmailEntity
        return TemporaryEmailEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FriedAppsSDK":
        if sdkopts is None:
            sdkopts = {}
