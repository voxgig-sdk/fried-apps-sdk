...
func TestTemporaryEmailEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set FRIEDAPPS_TEST_TEMPORARY_EMAIL_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func temporary_emailBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FRIEDAPPS_TEST_TEMPORARY_EMAIL_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FRIEDAPPS_TEST_TEMPORARY_EMAIL_ENTID"])
