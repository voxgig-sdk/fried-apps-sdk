...
func NewTemporaryEmailEntity(client *core.FriedAppsSDK, entopts map[string]any) *TemporaryEmailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TemporaryEmailEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TemporaryEmailEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TemporaryEmailListMatch and returns []TemporaryEmail. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TemporaryEmailEntity) ListTyped(reqmatch TemporaryEmailListMatch, ctrl map[string]any) ([]TemporaryEmail, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TemporaryEmail](res), nil
}
