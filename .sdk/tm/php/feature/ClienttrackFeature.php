...
// FriedApps SDK clienttrack feature
...
class FriedAppsClienttrackFeature extends FriedAppsBaseFeature
{
    ...
    public function PostConstruct(FriedAppsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FriedApps-SDK';
