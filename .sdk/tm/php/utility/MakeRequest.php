...
// FriedApps SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FriedAppsMakeRequest
{
    public static function call(FriedAppsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FriedAppsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FriedAppsResponse($fetched);
        } else {
