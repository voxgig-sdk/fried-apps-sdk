...
// FriedApps SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FriedAppsTransformResponse
{
    public static function call(FriedAppsContext $ctx): mixed
    {
        ...
        $transform = FriedAppsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
