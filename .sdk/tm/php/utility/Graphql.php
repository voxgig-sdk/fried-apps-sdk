...
class FriedAppsGraphql
{
    ...
    // equivalent.
    public static function body(FriedAppsContext $ctx): mixed
    {
    ...
    public static function errors(FriedAppsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
