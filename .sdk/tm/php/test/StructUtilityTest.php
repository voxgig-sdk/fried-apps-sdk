...
// FriedApps SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FriedAppsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FriedAppsOmni::structfix($now, Struct::undef()))
                        !== json_encode(FriedAppsOmni::structfix($val, Struct::undef()))) {
