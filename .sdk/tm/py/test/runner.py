...
class FriedAppsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FriedAppsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FriedAppsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FriedAppsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
