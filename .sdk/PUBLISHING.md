...
|---|---|---|
| `ts/` | @voxgig-sdk/fried-apps-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fried-apps-sdk \
      --repository voxgig-sdk/fried-apps-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fried-apps-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fried-apps-sdk --id=<id>` removes it.
