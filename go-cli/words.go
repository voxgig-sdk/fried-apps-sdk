...
func registerSDKWords(r *eng.Registry, client *sdk.FriedAppsSDK) {
...
func runOp(client *sdk.FriedAppsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
