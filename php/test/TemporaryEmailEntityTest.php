...
class TemporaryEmailEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FRIEDAPPS_TEST_TEMPORARY_EMAIL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function temporary_email_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FRIEDAPPS_TEST_TEMPORARY_EMAIL_ENTID");
