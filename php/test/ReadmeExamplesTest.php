...
// FriedApps SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FriedAppsSDK::test)
...
{
    private const SDK_CLASS = 'FriedAppsSDK';
    ...
    private const SDK_BASE = 'friedapps_sdk';
