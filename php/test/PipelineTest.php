...
{
    private static function utility(): FriedAppsUtility
    {
        return new FriedAppsUtility();
    }
    ...
    private static function ctx(array $over = []): FriedAppsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FriedAppsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FriedAppsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FriedAppsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FriedAppsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FriedAppsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FriedAppsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FriedAppsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FriedAppsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FriedAppsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FriedAppsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FriedAppsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FriedAppsResponse([]),
            'result' => new FriedAppsResult([]),
        ]);
        [, $err] = FriedAppsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FriedAppsSpec([]),
            'response' => null,
            'result' => new FriedAppsResult([]),
        ]);
        [, $err] = FriedAppsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FriedAppsSpec(['step' => 's']),
            'response' => new FriedAppsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FriedAppsResult([]),
        ]);
        [, $err] = FriedAppsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FriedAppsSpec(['step' => 's']),
            'response' => new FriedAppsResponse(self::resp(200, ['v' => 1])),
            'result' => new FriedAppsResult([]),
        ]);
        [, $err] = FriedAppsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FriedAppsSpec(['step' => 's']),
            'response' => new FriedAppsResponse(self::resp(200, ['v' => 2])),
            'result' => new FriedAppsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FriedAppsMakeResponse::call($ctx);
    ...
    {
        $preset = new FriedAppsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FriedAppsSpec([]),
            'response' => new FriedAppsResponse([]),
            'result' => new FriedAppsResult([]),
        ...
        [$got, $err] = FriedAppsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FriedAppsResult([])]);
        [, $err] = FriedAppsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FriedAppsSpec([]), 'result' => null]);
        [, $err] = FriedAppsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FriedAppsSpec(['step' => 's']),
            'result' => new FriedAppsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FriedAppsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FriedAppsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FriedAppsSpec(['step' => 's']),
            'result' => new FriedAppsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FriedAppsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FriedAppsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FriedAppsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FriedAppsSpec([]),
            'result' => new FriedAppsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FriedAppsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FriedAppsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FriedAppsError('boom', 'boom');
        $utility->fetcher = function (FriedAppsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FriedAppsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FriedAppsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FriedAppsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FriedAppsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FriedAppsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FriedAppsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FriedAppsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FriedAppsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FriedAppsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FriedAppsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FriedAppsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FriedAppsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FriedAppsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FriedAppsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FriedAppsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FriedAppsResult(['ok' => false])]);
        $this->expectException(FriedAppsError::class);
        FriedAppsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FriedAppsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FriedAppsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FriedAppsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FriedAppsBaseFeature();
        $b = new FriedAppsBaseFeature();
        FriedAppsFeatureAdd::call($ctx, $a);
        FriedAppsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FriedAppsBaseFeature
    {
        $f = new FriedAppsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FriedAppsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FriedAppsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FriedAppsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FriedAppsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FriedAppsResponse(['headers' => null]),
            'result' => new FriedAppsResult([]),
        ]);
        FriedAppsResultHeaders::call($ctx);
