...
// FriedApps SDK utility: fetcher

class FriedAppsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FriedAppsSDK/1.0)';
    ...
    public static function call(FriedAppsContext $ctx, string $fullurl, array $fetchdef): array
    {
