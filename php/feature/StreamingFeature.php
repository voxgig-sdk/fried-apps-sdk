...
// FriedApps SDK streaming feature
...
class FriedAppsStreamingFeature extends FriedAppsBaseFeature
{
    ...
    private function _iterate(FriedAppsResult $result): \Generator
    {
    ...
    private function _streamable(FriedAppsContext $ctx): bool
    {
