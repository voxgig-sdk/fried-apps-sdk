...
class FriedAppsRbacFeature extends FriedAppsBaseFeature
{
    ...
    private function _required(FriedAppsContext $ctx): ?string
    {
    ...
    private function _reject(FriedAppsContext $ctx, string $required): void
    {
    ...
    private function _track(FriedAppsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
