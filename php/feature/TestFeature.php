...
// FriedApps SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FriedAppsTestFeature extends FriedAppsBaseFeature
{
    ...
    public function init(FriedAppsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FriedAppsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FriedAppsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FriedAppsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FriedAppsContext $ctx, $op, $args): array
    {
