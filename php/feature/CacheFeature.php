...
class FriedAppsCacheFeature extends FriedAppsBaseFeature
{
    ...
    private function _through(FriedAppsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
