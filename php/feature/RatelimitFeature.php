...
// FriedApps SDK ratelimit feature
...
class FriedAppsRatelimitFeature extends FriedAppsBaseFeature
{
    ...
    private function _acquire(FriedAppsContext $ctx): void
    {
    ...
    private function _track(FriedAppsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
