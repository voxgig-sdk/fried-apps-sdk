...
class FriedAppsTimeoutFeature extends FriedAppsBaseFeature
{
    ...
    private function _with_timeout(FriedAppsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FriedAppsContext $_ctx, float $ms): void
    {
        $client = $this->client;
