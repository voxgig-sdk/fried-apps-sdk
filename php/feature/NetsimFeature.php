...
class FriedAppsNetsimFeature extends FriedAppsBaseFeature
{
    ...
    private function _simulate(FriedAppsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FriedAppsContext $ctx, array $applied): void
    {
        $client = $this->client;
