...
class FriedAppsProxyFeature extends FriedAppsBaseFeature
{
    ...
    public function init(FriedAppsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FriedAppsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
