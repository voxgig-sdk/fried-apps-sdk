...
func registerTools(server *mcp.Server, client *sdk.FriedAppsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fried-apps_list",
		Description: "List records from FriedApps. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fried-apps_load",
		Description: "Load a single record from FriedApps. " +
...
func runOp(client *sdk.FriedAppsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FriedAppsSDK, name string) (sdk.FriedAppsEntity, error) {
