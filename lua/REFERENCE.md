# FriedApps Lua SDK Reference

Complete API reference for the FriedApps Lua SDK.
...
| --- | --- | --- | --- |
| `domains` | `table` | No | List of available email domains |
...
```lua
local results, err = client:TemporaryEmail():list()
```
