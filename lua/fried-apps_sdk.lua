...
local FriedAppsSDK = {}
FriedAppsSDK.__index = FriedAppsSDK
...
FriedAppsSDK._make_feature = _make_feature


function FriedAppsSDK.new(options)
  local self = setmetatable({}, FriedAppsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function FriedAppsSDK:options_map()
...
function FriedAppsSDK:get_utility()
  return Utility.copy(self._utility)
end


function FriedAppsSDK:get_root_ctx()
  return self._rootctx
end


function FriedAppsSDK:prepare(fetchargs)
...
function FriedAppsSDK:direct(fetchargs)
...
-- by passing it.
function FriedAppsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function FriedAppsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "FriedAppsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function FriedAppsSDK:TemporaryEmail(data)
...
function FriedAppsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = FriedAppsSDK.new(sdkopts)
  sdk.mode = "test"
