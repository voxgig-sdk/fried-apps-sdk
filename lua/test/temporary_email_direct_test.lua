...
describe("TemporaryEmailDirect", function()
  it("should direct-list-temporary_email", function()
    local setup = temporary_email_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-temporary_email", setup.live and "live" or "unit")
