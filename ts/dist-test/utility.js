...
function envOverride(m) {
    if ('TRUE' === process.env.FRIED_APPS_TEST_LIVE ||
        'TRUE' === process.env.FRIED_APPS_TEST_OVERRIDE) {
    ...
    m.FRIED_APPS_TEST_EXPLAIN = process.env.FRIED_APPS_TEST_EXPLAIN || m.FRIED_APPS_TEST_EXPLAIN;
    return m;
}
