...
(0, node_test_1.describe)('TemporaryEmailDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FriedAppsSDK({
    ...
    (0, node_test_1.test)('direct-list-temporary_email', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-temporary_email', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FriedAppsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['FRIED_APPS_TEST_TEMPORARY_EMAIL_ENTID'];
    ...
    const client = new __1.FriedAppsSDK({
        base: 'http://localhost:8080',
